---
title: DM Note 플러그인 시스템
description: DM Note의 플러그인 시스템 개요 및 핵심 개념
asIndexPage: true
---
...
이를 통해 앱 동작을 확장하고, 실시간 통계 패널이나 키 입력 시각화 같은 고급 기능을 구현할 수 있습니다.
...
<Cards>
  <Card title="시작하기" href="/plugin/getting-started" />
  <Card title="선언형 API" href="/plugin/declarative-api" />
  <Card title="API 레퍼런스" href="/plugin/api-reference" />
  <Card title="예제 모음" href="/plugin/examples" />
</Cards>
