...
<Cards>
  <Cards.Card title="시작하기" href="/getting-started" />
  <Cards.Card title="선언형 API" href="/declarative-api" />
  <Cards.Card title="API 레퍼런스" href="/api-reference" />
  <Cards.Card title="예제 모음" href="/examples" />
</Cards>
